...
describe('isISO_3166', () => {
  it('works with known iso codes', () => {
    for (const code of Object.keys(ISO_3116_1__MAP)) {
    ...
    for (const code of Object.keys(ISO_3116_2__MAP)) {
      expect(isISO_3166(code)).toBeTruthy();
    ...
    for (const code of Object.keys(ISO_3116_2_CA__MAP)) {
      expect(isISO_3166(code)).toBeTruthy();
      expect(isISO_3166_2(code)).toBeTruthy();
    ...
    for (const code of Object.keys(ISO_3116_2_US__MAP)) {
      expect(isISO_3166(code)).toBeTruthy();
      expect(isISO_3166_2(code)).toBeTruthy();
